      ...
      await axios
        ...
        .then((response) => {
          ...
          if (statusCode === 200) {
            ...
            if (payload === 'pending') { commit('SET_PENDING_PROPOSALS', proposals || []) }
            if (payload === 'accepted') { commit('SET_ACCEPTED_PROPOSALS', proposals || []) }
            if (payload === 'declined') { commit('SET_DECLINED_PROPOSALS', proposals || []) }
