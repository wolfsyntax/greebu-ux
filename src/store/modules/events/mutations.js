...
export const nextPastPage = (state) => {
  if (state.pastPagination.page < state.pastPagination.last_page) { state.pastPagination.page++ }
}

export const nextUpcomingPage = (state) => {
  if (state.upcomingPagination.page < state.upcomingPagination.last_page) { state.upcomingPagination.page++ }
}

export const nextOngoingPage = (state, payload) => {
  if (state.ongoingPagination.page < state.ongoingPagination.last_page) { state.ongoingPagination.page++ }
}
...
export const setEventCreator = (state, payload = {}) => {
  state.eventCreator = payload
}

export const setEventStaff = (state, payload = []) => {
