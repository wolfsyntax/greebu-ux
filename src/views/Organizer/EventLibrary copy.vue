    ...
    <section class="library">
      ...
      <div v-if="activeItem === 'Featured Artist'" class="tab-pane active">
        ...
        <div>
          <audio-player
            ref="audioPlayer"
            :audio-list="artists.map((elm) => elm.song)"
...
export default {
  ...
  handleBeforePlay(next) {
      ...
      //  this.$set(this.isPlaying, index, true); // Set play state to true when the song is about to play.
        next();
    },
    // handlePlay() {
    //     const index = this.$refs.audioPlayer.currentPlayIndex;
    //     this.$set(this.isPlaying, index, true); // Set play state to true when the song is played.
    // },
    // handlePause() {
    //     const index = this.$refs.audioPlayer.currentPlayIndex;
    //     this.$set(this.isPlaying, index, false); // Set play state to false when the song is paused.
    // },
