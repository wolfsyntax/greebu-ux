        ...
        <div class="container">
          <div class="row profile-row">
            ...
            <div class="col-6">
              ...
              <h2 class="title">
                Welcome! Let's create your profile as an Event Organizer
              </h2>
              ...
              >
                ...
                <div class="required-fields">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      class="form-control organizer-name"
                      required
                      autocomplete="off"
                    />
                    <div
                      v-if="error?.organizer_name"
                      class="organizer-name-error text-danger"
                    ></div>
                  </div>
                  ...
                  <div class="form-group mb-0">
                    ...
                    <div
                      v-for="err in error?.event_types"
                      :key="err"
                      class="text-danger"
                    >
                      {{ err }}
                ...
                <div class="band-and-social">
                  <div class="form-group">
                    ...
                    <button
                      ...
                      @click="toggle('organizerStaff')"
                    >
                      <span class="material-symbols-rounded">add_box</span>Add
                      Member
                    </button>
                  </div>
                  ...
                  <transition name="fade" mode="out-in">
                    ...
                    >
                      <div class="row g-0">
                        <div class="col-md-1">
                          <img
                            src="/assets/social icons/_Facebook.svg"
                        ...
                        <div class="col-md-1">
                          <div class="d-flex align-items-center text-end">
                            ...
                            <button
                              type="button"
                              @click="removeSocialMedia('facebook')"
                              class="social-media-account-wrapper"
                            >
                              <img
                                src="/assets/artist-account/delete-band-member.svg"
                  ...
                  <transition name="fade" mode="out-in">
                    ...
                    >
                      <div class="row g-0">
                        <div class="col-md-1">
                          <img
                            src="/assets/social icons/_Threads.svg"
                            class="img-fluid rounded-start mx-2"
                            alt="Threads"
                          />
                        </div>
                ...
                >
                  <label class="form-check-label" for="flexSwitchCheckDefault"
                    >Do you want to accept proposal from artist?</label
                  >
                ...
                <div class="d-flex justify-content-between group-item">
                  <label class="form-check-label" for="flexSwitchCheckDefault"
                    >Do you want to send proposal to artist?</label
                  >
                  <div class="form-check form-switch">
                    <input
                      class="form-check-input"
              ...
              <div
                class="modal fade"
                id="successDetailsModal"
                tabindex="-1"
                aria-labelledby="successDetailsLabel"
                aria-hidden="true"
              >
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                      ...
                      <p class="content">
                        Lorem ipsum dolor sit amet consectetur. Morbi lacus sit
                        massa ligula nullam in mauris eget metus.
                      </p>
                    </div>

                    <div class="modal-footer">
                      <a href="/artist" class="view-profile"
                        >View Your Profile</a
                      >
                    </div>
                  </div>
...
export default {
  ...
  mounted () {
    ...
    if (this.userRole === 'organizer') {
      ...
      this.fetchOrganizerOptions().then((res) => {
  ...
  methods: {
    ...mapActions(['fetchOrganizerOptions', 'fetchProfile', 'removeStaff']),
