      ...
      <div class="container">
        <div class="row profile-row">
          ...
          <div class="col-6">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <span class="material-symbols-rounded close-modal-icon" data-dismiss="modal"
                      @click="toggle">close</span>
            ...
            <form @submit.prevent="submit" class="fill-details">
              ...
              <div class="required-fields">
                ...
                <div class="form-group">
                  ...
                  <multiselect v-model="form.genre" :options="genres" mode="tags" class="genre"
              ...
              <div class="band-and-social">
                <div class="form-group">
                  ...
                  <button type="button" class="btn btn-primary add-member" @click="toggle()"><span
                      class="material-symbols-rounded">add_box</span>Add Member</button>
                </div>
                ...
                <div class="form-group">
                  ...
                  <button type="button" class="btn btn-primary add-social-media" @click="toggle('links')"><span
                      class="material-symbols-rounded">add_link</span>Add Links</button>
                </div>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-10">
                      <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-body-secondary">{{ artistProfile?.youtube_channel
                        }}</small></p>
                      </div>
                    </div>
                    <div class="col-md-1">
              ...
              <div class="d-flex justify-content-between group-item">
                <label class="form-check-label" for="flexSwitchCheckDefault">Do you want to accept booking for special
                  occassions?</label>
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                </div>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-10">
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="text-body-secondary">{{ artistProfile?.instagram_username
                      }}</small></p>
                    </div>
                  </div>
                  <div class="col-md-1">
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-10">
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="text-body-secondary">{{ artistProfile?.twitter_username
                      }}</small></p>
                    </div>
                  </div>
                  <div class="col-md-1">
            ...
            <!-- Modal -->
            <div class="modal fade" id="successDetailsModal" tabindex="-1" aria-labelledby="successDetailsLabel"
              aria-hidden="true">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                      <g clip-path="url(#clip0_4710_61743)">
                        <path
                      ...
                      <defs>
                        <clipPath id="clip0_4710_61743">
                          <rect width="48" height="48" fill="white" />
                        </clipPath>
                      </defs>
                    </svg>
                    <h3 class="title">You’re all set!</h3>
                    <p class="content">Lorem ipsum dolor sit amet consectetur. Morbi lacus sit massa ligula nullam in
                      mauris eget metus.</p>
                  </div>
