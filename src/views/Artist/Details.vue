                ...
                <div class="cover" >
                  ...
                  <div class="row cover-body d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-3">
                      ...
                      <!-- <pre> <b>Artist Profile</b> {{  [{{ artistProfile }}]  }} <br></pre>
                      {{ $route.params?.id }} -->
              ...
              <div class="card band-members">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between header">
                    ...
                    <div class="see-all">
                      <a href="#" data-bs-toggle="modal" data-bs-target="#editBandMembers">See all</a>
                    </div>
                  </div>
          ...
          <div class="row about-tab" v-if="activeItem === 'About'">
            ...
            <div class="col-5">
              <div class="social-media">
                <h4>Social Media</h4>
                <ul>
                  <li><img src="/assets/artist-account/type-of-artist-icon-gray.svg" alt="artist type icon">{{ artist?.artist_name }}</li>
