<template>
  <div>
    ...
    <!-- Modal -->
    <div class="modal fade " id="artistPost"  tabindex="-1" 
              ...
              >
                <div class="text-center upload-file-content">
                  <svg xmlns="http://www.w3.org/2000/svg" width="45" height="59" viewBox="0 0 45 59" fill="none">
                    ...
                    <defs>
                      <clipPath id="clip0_3478_73591"><rect width="45" height="58" fill="white" transform="translate(0 0.5)"/></clipPath>
                    </defs>
                  </svg>
                  ...
                  <div class="upload-wrapper">
                    ...
                    <input type="file" class="upload-music" id="files" style="display:none;" 
                      ref="musicInput" @change="handleMusicUpload" accept="audio/*" 
                    />
                  </div>
                </div>
              </div>
        ...
        <div class="modal-content" v-else-if="selectedItem === 'feeling'">
          <div class="modal-header">
            <h2 class="modal-title" id="artistPostLabel">
              <span class="material-symbols-rounded back-to-post" @click="toggleContent('feeling')">arrow_back</span>Feelings
            </h2>
          ...
          <div class="modal-body">
            <div class="search-container">
              <input type="text" class="search-input" placeholder="Search emoji" v-model="iconFilter">
            ...
            <div class="d-flex align-items-center icons-list" v-for="(emoticon, index) in iconList" :key="index">
              <div class="left-icon" style="text-transform: capitalize;" v-if="emoticon[0]">
                <img :src="emoticon[0].path" class="img-fluid" :alt="`emoticon-${emoticon[0].text}`" >{{ emoticon[0].text }}
              </div>
              <div class="right-icon" style="text-transform: capitalize;" v-if="emoticon[1]">
                <img :src="emoticon[1].path" class="img-fluid" :alt="`emoticon-${emoticon[1].text}`" >{{ emoticon[1].text }}
              </div>
            </div>
