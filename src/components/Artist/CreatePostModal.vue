        ...
        >
          ...
          <div class="modal-body">
            <div class="d-flex align-items-center artist-image">
              <img
                src="https://res.cloudinary.com/daorvtlls/image/upload/v1686465790/cld-sample.jpg"
                alt="profile"
              />
            ...
            <form @submit.prevent="submitForm">
              ...
              <div
                ...
                @dragover="handleDragOverFile"
                @dragleave="handleDragLeaveFile"
                @drop="handleDropFile"
                :class="{ 'drag-over': isDragOverFiles }"
              >
                  ...
                  <div class="row">
                    ...
                    >
                      ...
                      <div v-if="index !== 2">
                        <template v-if="file.type.startsWith('video/')">
                          ...
                          <span
                            class="material-symbols-outlined remove-img"
                      ...
                      <div v-else class="image-container">
                        ...
                        <template v-if="file.type.startsWith('video/')">
                          ...
                          >
                          <span
                            v-if="additionalFilesCount > 0"
                            class="image-count"
                            >+{{ additionalFilesCount }}</span
                          >
                        </template>
                    ...
                    <div class="col-6 text-center uploaded-images">
                      <div class="upload-more" @click="uploadImage">
                        <span class="material-symbols-outlined add-photo-icon"
                          >&#xe43e;</span
                        >
              ...
              <!-- MUSIC SELECTED -->
              <div
                v-if="selectedItem === 'music'"
                class="upload-file-wrapper"
                @dragover="handleDragOverMusic"
                @dragleave="handleDragLeaveMusic"
                @drop="handleDropMusic"
                :class="{ 'drag-over': isDragOverMusic }"
              >
              ...
              <div v-if="uploadedMusic" class="uploaded-song-wrapper">
                ...
                <div class="d-flex align-items-center remove-music-wrapper">
                  ...
                  <span
                    class="material-symbols-outlined remove-music"
                    @click="removeMusic"
                    >&#xe5cd;</span
                  >
                </div>
              ...
              <div class="d-flex align-items-center manage-to-post">
                <div class="d-flex align-items-center feeling">
                  <button
                    ...
                    @click="toggleContent('feeling')"
                  >
                    <span
                      :class="{
                        'material-symbols-rounded post-icon': true,
                        selected: selectedItem === 'feeling',
                      }"
                      >&#xe813;</span
                    >
                    <span :class="{ selected: selectedItem === 'feeling' }"
                      >Feeling</span
                    >
                  </button>
                </div>
                ...
                <div class="d-flex align-items-center photo-video">
                  <button
                    type="button"
                    class="btn d-flex align-items-center"
                    @click="toggleContent('photo')"
                  >
                    <span
                      :class="{
                        'material-symbols-rounded post-icon': true,
                        selected: selectedItem === 'photo',
                      }"
                      >&#xe3f4;</span
                    >
                    <span :class="{ selected: selectedItem === 'photo' }"
                      >Photo/Video</span
                    >
                  </button>
                </div>
                ...
                <div class="d-flex align-items-center music">
                  ...
                  >
                    <span
                      :class="{
                        'material-symbols-rounded post-icon': true,
                        selected: selectedItem === 'music',
                      }"
                      >&#xe030;</span
                    >
                    <span :class="{ selected: selectedItem === 'music' }"
                      >Music</span
                    >
                  </button>
                </div>
              ...
              <div class="text-center button-wrapper">
                <button type="submit" class="btn" data-bs-dismiss="modal">
                  <span v-if="isLoading">
                    <i class="busy-submitting-post"></i>Post
                  </span>
        ...
        <div class="modal-content" v-else-if="selectedItem === 'feeling'">
          <div class="modal-header">
            <h2 class="modal-title" id="artistPostLabel">
              <span
                class="material-symbols-rounded back-to-post"
                @click="toggleContent('feeling')"
                >arrow_back</span
              >Feelings
            </h2>
          ...
          <div class="modal-body">
            ...
            <!-- <div class="d-flex align-items-center icons-list">
              <div class="left-icon">
                <img src="/assets/artist-account/emojis/happy.svg" class="img-fluid" alt="emoticon-happy">Happy
              </div>

              <div class="right-icon">
                <img src="/assets/artist-account/emojis/sad.svg" class="img-fluid" alt="emoticon-sad" >Sad
              </div>
            </div>

            <div class="d-flex align-items-center icons-list">
              <div class="left-icon">
                <img src="/assets/artist-account/emojis/blessed.svg" class="img-fluid"  alt="emoticon-blessed">Blessed
              </div>

              <div class="right-icon">
                <img src="/assets/artist-account/emojis/thankful.svg" class="img-fluid" alt="emoticon-thankful" >Thankful
              </div>
            </div>

            <div class="d-flex align-items-center icons-list">
              <div class="left-icon">
                <img src="/assets/artist-account/emojis/loved.svg" class="img-fluid" alt="emoticon-loved" >Loved
              </div>

              <div class="right-icon">
                <img src="/assets/artist-account/emojis/inlove.svg" class="img-fluid" alt="emoticon-inLove" >Inlove
              </div>
            </div>

            <div class="d-flex align-items-center icons-list">
              <div class="left-icon">
                <img src="/assets/artist-account/emojis/lovely.svg" class="img-fluid" alt="emoticon-lovely" >Lovely
              </div>

              <div class="right-icon">
                <img src="/assets/artist-account/emojis/grateful.svg" class="img-fluid" alt="emoticon-grateful" >Grateful
              </div>
            </div>

            <div class="d-flex align-items-center icons-list">
              <div class="left-icon">
                <img src="/assets/artist-account/emojis/excited.svg" class="img-fluid" alt="emoticon-excited" >Excited
              </div>

              <div class="right-icon">
                <img src="/assets/artist-account/emojis/fantastic.svg" class="img-fluid" alt="emoticon-fantastic" >Fantastic
              </div>
            </div>

            <div class="d-flex align-items-center icons-list">
              <div class="left-icon">
                <img src="/assets/artist-account/emojis/crazy.svg" class="img-fluid" alt="emoticon-crazy" >Crazy
              </div>

              <div class="right-icon">
                <img src="/assets/artist-account/emojis/cool.svg" class="img-fluid" alt="emoticon-cool" >Cool
              </div>
            </div> -->

            <div
              class="d-flex align-items-center icons-list"
              v-for="(emoticon, index) in iconList"
              :key="index"
            >
              <div
                class="left-icon"
              ...
              >
                <img
                  :src="emoticon[1].path"
                  class="img-fluid"
                  :alt="`emoticon-${emoticon[1].text}`"
                />{{ emoticon[1].text }}
              </div>
            </div>

            <div class="text-center button-wrapper">
              <button type="submit" class="btn" @click="showCreatePost = true">
                Done
              </button>
            </div>
          </div>
...
export default {
  ...
  data () {
    return {
      ...
      isLoading: false,
      isDragOverFiles: false,
      isDragOverMusic: false,
  ...
  computed: {
    ...mapGetters(['isLoggedIn', 'emoticonsList']),
    ...mapState({
      emoticons: (state) => state.posts.emoticons
    }),
    iconList () {
      if (this.iconFilter === '') return this.filterEmoticon(this.emoticons)

      const startsWith = (el, wordToCompare) => {
        return el.text.includes(wordToCompare)
      }

      // eslint-disable-next-line no-var
      var ico = this.emoticons.filter((el) => {
        return startsWith(el, this.iconFilter)
      })

      if (ico) {
        return this.filterEmoticon(ico)
      }
  ...
  watch: {
    submittedTime () {
      this.timeDifference = Math.floor(
        (new Date() - this.submittedTime) / 1000
      )
    }
  },
  methods: {
    ...
    handleDragOverFile (event) {
      ...
      this.isDragOverFiles = true
    },
    handleDragLeaveFile (event) {
      event.preventDefault()
      this.isDragOverFiles = false
    },
    ...
    handleDragLeaveMusic (event) {
      event.preventDefault()
      this.isDragOverMusic = false
    },
    handleDropMusic (event) {
      event.preventDefault()
