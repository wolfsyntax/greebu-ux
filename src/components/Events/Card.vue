      ...
      <div class="row">
        <div class="col">
          <div class="seeking-for" v-if="(userRole === 'artists' || userRole === 'organizer') && event.look_types.length > 0" >
            ...
            <span class="badge type-artist" v-for="(look, index) in event.look_types.slice(0,1)" :key="index">{{ look.substring(0,9) }}...</span>
          ...
          <div class="seeking-for" v-if="(userRole === 'artists' || userRole === 'organizer') && event.look_types.length === 0" >
            ...
            <span class="badge type-artist" style="opacity: 0;">{{ 'acoustic band'.substring(0,9)}}...</span>
          </div>
        </div>
