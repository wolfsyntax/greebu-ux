<template>
  <div>
      ...
      <div class="d-flex align-items-center justify-content-between event-description">
        ...
        <div class="d-flex align-items-center left-wrap organizer-offers-details-wrap">
          ...
          <div>
            ...
            <h5 class="from"><span>From:</span> KC event organizer 
        ...
        <div class="details-wrapper">
          <div class="button-wrapper">
            <button type="button" class="btn details" @click="showFromOrganizerModal = true">View Proposal</button>
          </div>
        </div>  
    ...
    <div class="customized-songs-wrapper">
      <div class="d-flex align-items-center justify-content-between event-description">
        ...
        <div class="d-flex align-items-center left-wrap organizer-offers-details-wrap">
          ...
          <div>
            <h5 class="from"><span>To:</span>  KC event organizer
              <span class="cancelled">Cancelled</span> 
            </h5>
            <h6 class="d-flex align-items-center venue">Event Organizer
            <span class="material-symbols-rounded dot-icon">&#xe061;</span>
    ...
    <view-proposal-modal :show="showFromOrganizerModal" @close-modal="closeFromOrganizerModal" @accept-request="onModalAccepted" />
  </div>
</template>
