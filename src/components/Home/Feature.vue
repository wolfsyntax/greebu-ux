  ...
  <div>
        ...
        <div v-if="showOnboardingMessage">
          ...
          <div class="modal">
            <div class="modal-content">
              ...
              <p class="description">
                Welcome to Geebu! We're thrilled to have you on board. Get ready
                to embark on an exciting journey of Music and Events, and
                explore a world of possibilities. Whether you're a seasoned user
                or just starting out, we're here to support you every step of
                the way. Let's dive in and make the most of your experience with
                Geebu together!"
              </p>
              <label
                for="modal-toggle"
        ...
        <div class="onboarding-message" v-if="showOnboardingMessage">
          ...
          <div class="modal">
            <div class="modal-content">
              <h2 class="title">Welcome Aboard!</h2>
              <p class="description">
                In order to access the full range of features within the app, it
                is necessary to subscribe to the artist plan. You can still
                browse the app and explore its interface, but your access to
                certain features will be limited until you upgrade to the
                subscription.
              </p>
              <label
                for="modal-toggle"
      ...
      <div class="onboarding-message" v-if="userRole === 'organizer'">
        <div v-if="showOnboardingMessage">
          ...
          <div class="modal">
            <div class="modal-content">
              <h2 class="title">Welcome Aboard!</h2>
              <p class="description organizer-description">
                Welcome to Geebu! Your Trusted Partner in Event Creation and
                Management. Where you can able to:
              </p>
              <ul class="offers">
                <li>Create Event</li>
        ...
        >
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img
                src="/assets/home/home-slider-1.webp"
                class="d-block w-100"
                alt="Book your Events/Artist, Create your song now let's make magic in music!"
              />
              <div class="carousel-caption d-none d-md-block">
                <h1>
                  Book your Events/Artist, Create your song now let's make magic
                  in music!
                </h1>
                <p>
            ...
            <div class="carousel-item">
              <img
                src="/assets/home/home-slider-2.webp"
                class="d-block w-100"
                alt="Find a perfect artists to make a custom song and create amazing memories to your event"
              />
              <div class="carousel-caption d-none d-md-block">
                <h3>
                  Find a perfect artists to make a custom song and create
                  amazing memories to your event
                </h3>
                <p>
                  Custom tunes for any mood, and booking the best artists just
                  got easier with our website!
                ...
                <div v-if="isLoggedIn">
                  <a href="/artist" class="btn btn-primary btn-lg"
                    >Find your artist</a
                  >
                </div>
                <div v-else>
              ...
              <div class="animate-section">
                <div class="animate-left">
                  <img
                    src="/assets/home/slider-2-animation-1.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                  <img
                    src="/assets/home/slider-2-animation-2.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                  <img
                    src="/assets/home/slider-2-animation-3.webp"
                    class="d-block w-100"
                    alt="Singing"
                  />
                  <img
                    src="/assets/home/slider-2-animation-4.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                  <img
                    src="/assets/home/slider-2-animation-5.webp"
                    class="d-block w-100"
                    alt="Singing"
                  />
                  <img
                    src="/assets/home/slider-2-animation-6.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                </div>
                <div class="animate-right">
                  <img
                    src="/assets/home/slider-2-animation-7.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                  <img
                    src="/assets/home/slider-2-animation-8.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                  <img
                    src="/assets/home/slider-2-animation-9.webp"
                    class="d-block w-100"
                    alt="Singing"
                  />
                  <img
                    src="/assets/home/slider-2-animation-10.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                  <img
                    src="/assets/home/slider-2-animation-11.webp"
                    class="d-block w-100"
                    alt="Singing"
                  />
                  <img
                    src="/assets/home/slider-2-animation-12.webp"
                    class="d-block w-100"
                    alt="Playing guitar"
                  />
                </div>
            ...
            <div class="carousel-item">
              <img
                src="/assets/home/home-slider-3.webp"
                class="d-block w-100"
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <p>
                  We offer a wide range of equipment rental options, including
                  sound systems, lighting, staging, and more.
                </p>
            ...
            <div class="carousel-item">
              <img
                src="/assets/home/home-slider-4.webp"
                class="d-block w-100"
              ...
              <div class="carousel-caption d-none d-md-block content-4">
                <h3>
                  No worries if you're unsure how to create an event - we've got
                  you covered! Come and easily create your own event with us
                  today.
                </h3>
                <p>
                  We offer a wide range of equipment rental options, including
      ...
      <div class="container">
        <div class="row">
          <h2 class="text-center title">
            Unlock the Rhythm of Your Celebrations!
          </h2>
          <div class="col-6">
            <p class="content">Experience the Ultimate Fusion of Creativity and Entertainment
              with Geebu Create Your Custom Song, Tailored Exclusively for Your
              Special Event or Party. Connect with Talented Artists Ready to
              Elevate Your Celebrations to Unforgettable Heights. Get Started
              Today and Let the Music Speak the Language of Your Joy!"
            </p>
            <ul>
             <!-- eslint-disable-next-line vue/require-v-for-key -->
              <li v-for="feature in geebuFeatures"> {{ feature }} </li>
            </ul>
            <router-link to="/login" class="btn btn-primary btn-lg learn-more"
          ...
          <div class="col-6">
            <div class="video-container">
              ...
              >
                <img
                  src="/assets/video-play-icon.svg"
                  alt="Click to play the video"
                />
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          >
            <div class="carousel-indicators">
              <button
                type="button"
                data-bs-target="#custom-song-carousel"
                data-bs-slide-to="0"
                class="active"
                aria-current="true"
                aria-label="Slide 1"
                ...
                <div class="row">
                  <div class="col-lg-6 col-xl-5 col-xxl-5">
                    <div class="carousel-caption d-none d-md-block step1">
                      ...
                      <p>Tell us who the song is for or what it’s all about.
                        Artist just need a little inspiration to make it trully
                        custom and unique.
                      </p>
                      <a href="/create-song" class="btn btn-primary btn-lg"
                        >Create your song</a
                  ...
                  <div class="col-lg-6 col-xl-7 col-xxl-7">
                    <div class="customg-song-img">
                      <img
                        src="/assets/home/your-song.webp"
                        class="d-block w-100"
                        loading="lazy"
                        alt="Custom song"
                      />
                ...
                <div class="row">
                  <div class="col-lg-6 col-xl-5 col-xxl-5">
                    <div class="carousel-caption d-none d-md-block step2">
                      ...
                      <p>Select the artist you want. Then pick your preffered
                        genre, tempo, and mood so that they can get started.
                      </p>
                      <a href="/artists" class="btn btn-primary btn-lg"
                        >Find Your Artist</a
                      >
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-xl-5 col-xxl-5">
                    <div class="carousel-caption d-none d-md-block step3">
                      ...
                      <p>Any story can inspire a song. Let us guide you through
                        the creation process and make a song.
                      </p>
                      <a href="/create-song" class="btn btn-primary btn-lg"
                        >Create your song</a
                      >
    ...
    <section class="discover-artist">
      <div class="container">
        ...
        <p class="sub-heading">Impress your audience with unforgettable performances, easily source
          and book the perfect artist for any occasion.
        </p>
        <div class="wrapper">
          <div class="row available-artist">
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              <div class="content">
                ...
                <p>Our platform allows you to choose from a wide selection of
                  available artists who are ready to make your event
                  unforgettable.
                </p>
                <ul>
                  <li>Filter by Genre and Style</li>
                  <li>Match Your Budget and Event Type</li>
                  <li>Find Local Gems and Rising Stars</li>
                </ul>
                <a href="/artists" class="btn btn-primary btn-lg"
                  >Find your artist</a
                >
            ...
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              ...
              >
                <div class="carousel-indicators">
                  <button
                    type="button"
                    data-bs-target="#availableArtist"
                    data-bs-slide-to="0"
                    class="active"
                    aria-current="true"
                    aria-label="Slide 1"
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img
                      src="/assets/home/available-artist-slider-1.webp"
                      class="d-block w-100"
                      loading="lazy"
                  ...
                  <div class="carousel-item">
                    <img
                      src="/assets/home/available-artist-slider-2.webp"
                      class="d-block w-100"
                      loading="lazy"
                      alt="Choose available artist"
                    />
                  ...
                  <div class="carousel-item">
                    <img
                      src="/assets/home/available-artist-slider-3.webp"
                      class="d-block w-100"
                      loading="lazy"
                      alt="Choose available artist"
                    />
          ...
          <div class="row book-your-event">
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              ...
              >
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img
                      src="/assets/home/book-event-slider-1.webp"
                      class="d-block w-100"
                      loading="lazy"
                      alt="Choose available artist"
                    />
                  ...
                  <div class="carousel-item">
                    <img
                      src="/assets/home/book-event-slider-2.webp"
                      class="d-block w-100"
                      loading="lazy"
                      alt="Choose available artist"
                    />
                  ...
                  <div class="carousel-item">
                    <img
                      src="/assets/home/book-event-slider-3.webp"
                      class="d-block w-100"
                      loading="lazy"
                      alt="Choose available artist"
                    />
            ...
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              <div class="content">
                ...
                <p>With our platform, you can easily set and book your event,
                  ensuring that everything runs smoothly from start to finish.
                </p>
                <ul>
                  <li>Effortless Date and Time Selection</li>
                  <li>Streamlined and Direct Communication with artists</li>
                  <li>Secure Payment and Scheduling Tools</li>
                </ul>
    ...
    <section class="songs-for-occasion">
      <div class="container">
        ...
        <p class="sub-heading">Every Chapter Has a Perfect Harmony.</p>
        <div class="row">
          <!-- eslint-disable-next-line vue/require-v-for-key -->
    ...
    <section class="testimonials">
      <div class="container">
        ...
        <p class="sub-heading">Real People. Real Voices.</p>
                  ...
                  <div class="video-container">
                    <div class="video">
                      <video
                        :src="review.video"
                        ref="videos"
                        @click="toggleTestimonialVideo(index)"
                      ></video>
                      <div
                        class="play-button"
                        v-if="!review.playing"
...
export default {
  ...
  data () {
    return {
      ...
      geebuFeatures: [
        'Create a Song',
        'Booked Artist for Special Occasions and Events',
        'Post Events',
        'Hire Artist for your Events',
        'Post your Original and Cover Songs',
        'Listen to Artist songs'
      ],
    ...
    this.observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (
          ...
          entry.target === this.$refs.customSongSection
        ) {
